<template>
  <div class="learn">
    <div class="content">
      ...
      <img src="../../public/img/yandex-disk.png" alt="">
      <img src="../../public/img/cloud.png" alt="">
      <img src="../../public/img/cloudy.png" alt="">
      <img src="../../public/img/dog.png" alt="">
      <img src="../../public/img/spideroak.png" alt="">
      <img src="../../public/img/spideroak.png" alt="">
      <img src="../../public/img/sugarsync.png" alt="">
    </div>
    <div class="com">
      <i class="iconfont icon-iconfont-left" @click="$router.push('/2'),$emit('changeRouter','fade')"></i>
      <i class="iconfont icon-iconfontplatformentrance" @click="$router.push('/4'),$emit('changeRouter','fade2')"></i>
    </div>
  </div>
</template>
<script>
